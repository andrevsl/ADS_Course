...
def main():
	...
	ltdSubst=r"simulation/TutorialTemplate_lib/%Layout1/rfpro/extra/0/proj.ltd"
	cell=r"Layout1"
	layout=r"layout1"
	sipiSetup=r"rfpro"
	libS3D=r"simulation/TutorialTemplate_lib/%Layout1/rfpro/extra/0/proj_libS3D.xml"
	varDictionary={}
	exprDictionary={}
	...
	shutil.move(r"C:\Users\simucstvsl\ADSCourse\TutorialTemplate\TutorialTemplate\_rfproBoot.py", r"C:\Users\simucstvsl\ADSCourse\TutorialTemplate\TutorialTemplate\_rfproBoot.pyo")
