...
class projImporter():
	...
	def create_materials(self,materialForEachLayer=False):
		...
		extraMaterialProperties=(162,1e-09,False,False) # (priority,thickness,modelTypeForMetals,convertedToResistance)
		material=ADSmaterialMap.get((ADSmaterialName,extraMaterialProperties),None)
		if material == None:
			EMProMaterialName = self._getEMProMaterialName(ADSmaterialName,ADSmaterialMap,extraMaterialProperties,ADSmaterialsNo1to1)
			material=self.session.create_material(name=EMProMaterialName, color=(238,106,80,255), thickness="1e-09 m", resistance=0)
			try:
		...
		ADSmaterialName=["Rogers_RO4350","__SubstrateLayer1"][materialForEachLayer]
		extraMaterialProperties=(50,None,None,False) # (priority,thickness,modelTypeForMetals,convertedToResistance)
		material=ADSmaterialMap.get((ADSmaterialName,extraMaterialProperties),None)
		if material == None:
			EMProMaterialName = self._getEMProMaterialName(ADSmaterialName,ADSmaterialMap,extraMaterialProperties,ADSmaterialsNo1to1)
			material=self.session.create_material(name=EMProMaterialName, color=(202,225,255,128), permittivity=3.66, losstangent=0.004, permeability=1, use_djordjevic=True, lowfreq=1000, evalfreq=10000000000, highfreq=1000000000000)
			try:
	...
	def create_geometry(self,topAssembly):
		...
		assembly=empro.geometry.Assembly()
		part=empro.geometry.Model()
		simBox = empro.geometry.Box( _createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox-xLowerBoundingBox", "abs((-0.0069-xLowerExtension)-(0.023106+xUpperExtension))"), _createIfToggleExtensionToBoundingBoxExpression("zUpperBoundingBox-zLowerBoundingBox", "((((stack_substrate1_layer_3_Z) + (zUpperExtension)) - (stack_substrate1_layer_1_Z)))"), _createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox-yLowerBoundingBox" , " abs((-0.003-yLowerExtension)-(0.003+yUpperExtension))"))
		part.recipe.append(simBox)
		part.coordinateSystem.anchorPoint = empro.geometry.CoordinateSystemPositionExpression(V(_createIfToggleExtensionToBoundingBoxExpression("(xUpperBoundingBox+xLowerBoundingBox)/2", "(0.023106+xUpperExtension+-0.0069-xLowerExtension)/2"), _createIfToggleExtensionToBoundingBoxExpression("(yUpperBoundingBox+yLowerBoundingBox)/2", "(0.003+yUpperExtension+-0.003-yLowerExtension)/2"), _createIfToggleExtensionToBoundingBoxExpression("zLowerBoundingBox","((stack_substrate1_layer_1_Z) - (0))")))
		...
		self.session.adjust_view()
		assembly=empro.geometry.Assembly()
		pointString='0.023106+xUpperExtension#-0.003-yLowerExtension;0.023106+xUpperExtension#0.003+yUpperExtension;-0.0069-xLowerExtension#0.003+yUpperExtension;-0.0069-xLowerExtension#-0.003-yLowerExtension'
		sketch = self._create_sketch(pointString)
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex0",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0069-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.003-yLowerExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex1",V(_createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox","0.023106+xUpperExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.003-yLowerExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex2",V(_createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox","0.023106+xUpperExtension"),_createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox","0.003+yUpperExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex3",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0069-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox","0.003+yUpperExtension"),0)))
		part=empro.geometry.Model()
		part.recipe.append(empro.geometry.Extrude(sketch,"(stack_substrate1_layer_3_Z) - (stack_substrate1_layer_1_Z)",V(0,0,1)))
		...
		topAssembly.append(assembly)
		assembly=empro.geometry.Assembly()
		pointStrings=['0.005106#-0.003;0.005106#-0.0001;0.011106#-0.0001;0.011106#-0.003;0.017106#-0.003;0.017106#-0.0001;0.023106#-0.0001;0.023106#0.0001;0.017106#0.0001;0.017106#0.003;0.011106#0.003;0.011106#0.0001;0.005106#0.0001;0.005106#0.003;-0.0009#0.003;-0.0009#0.0001;-0.0069#0.0001;-0.0069#-0.0001;-0.0009#-0.0001;-0.0009#-0.003']
		...
		assembly.name="hole"
		assembly=empro.geometry.Assembly()
		pointStrings=['0.026231#-0.006125;0.026231#0.006125;-0.010025#0.006125;-0.010025#-0.006125']
		sketch = None
		for pointString in pointStrings:
			sketch = self._create_sketch(pointString, sketch)
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex0",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0069-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.003-yLowerExtension"),0)))
	...
	def create_ports( self, topAssembly, includeInvalidPorts=True, symbPinData=None):
		...
		head=V("(-0.0069) - (0)","(0) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		tail=V("(-0.0069) - (0)","(0) - (0)","(stack_substrate1_layer_1_Z) - (0)")
		extent=empro.components.SheetExtent()
		extent.endPoint1Position=V("(-0.0069) - (0)","(-0.0001) - (0)","(stack_substrate1_layer_1_Z) - (0)")
		extent.endPoint2Position=V("(-0.0069) - (0)","(0.0001) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		...
		head=V("(0.023106) - (0)","(0) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		tail=V("(0.023106) - (0)","(0) - (0)","(stack_substrate1_layer_1_Z) - (0)")
		extent=empro.components.SheetExtent()
		extent.endPoint1Position=V("(0.023106) - (0)","(-0.0001) - (0)","(stack_substrate1_layer_1_Z) - (0)")
		extent.endPoint2Position=V("(0.023106) - (0)","(0.0001) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
	...
	def create_parameters(self):
		...
		self._create_parameter("stack_substrate1_layer_3_Z", "0.508 mm", "Z of topology level (level 3 of stack substrate1)",True,fixGridAxis='Z')
		...
		self._create_parameter("mask_hole_Zmin",str("0 mm"),"Zmin of mask hole",True,fixGridAxis='Z')
		self._create_parameter("mask_hole_Zmax",str("0.508 mm"),"Zmax of mask hole",True,fixGridAxis='Z')
		self._create_parameter("mask_cond_Zmin",str("0.508 mm"),"Zmin of mask cond",True,fixGridAxis='Z')
