...
class projImporter():
	...
	def create_materials(self,materialForEachLayer=False):
		...
		extraMaterialProperties=(162,1.8e-05,False,False) # (priority,thickness,modelTypeForMetals,convertedToResistance)
		material=ADSmaterialMap.get((ADSmaterialName,extraMaterialProperties),None)
		if material == None:
			EMProMaterialName = self._getEMProMaterialName(ADSmaterialName,ADSmaterialMap,extraMaterialProperties,ADSmaterialsNo1to1)
		...
		ADSmaterialName=["FR_4_Core","__SubstrateLayer1"][materialForEachLayer]
	...
	def create_geometry(self,topAssembly):
		...
		assembly=empro.geometry.Assembly()
		part=empro.geometry.Model()
		simBox = empro.geometry.Box( _createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox-xLowerBoundingBox", "abs((-0.0014-xLowerExtension)-(0.0186+xUpperExtension))"), _createIfToggleExtensionToBoundingBoxExpression("zUpperBoundingBox-zLowerBoundingBox", "((((stack_tech_layer_7_Z) + (zUpperExtension)) - ((stack_tech_layer_1_Z) - (zLowerExtension))))"), _createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox-yLowerBoundingBox" , " abs((0.0038-yLowerExtension)-(0.0238+yUpperExtension))"))
		part.recipe.append(simBox)
		part.coordinateSystem.anchorPoint = empro.geometry.CoordinateSystemPositionExpression(V(_createIfToggleExtensionToBoundingBoxExpression("(xUpperBoundingBox+xLowerBoundingBox)/2", "(0.0186+xUpperExtension+-0.0014-xLowerExtension)/2"), _createIfToggleExtensionToBoundingBoxExpression("(yUpperBoundingBox+yLowerBoundingBox)/2", "(0.0238+yUpperExtension+0.0038-yLowerExtension)/2"), _createIfToggleExtensionToBoundingBoxExpression("zLowerBoundingBox","(((stack_tech_layer_1_Z) - (zLowerExtension)) - (0))")))
		...
		self.session.adjust_view()
		assembly=empro.geometry.Assembly()
		pointString='0.0186+xUpperExtension#0.0038-yLowerExtension;0.0186+xUpperExtension#0.0238+yUpperExtension;-0.0014-xLowerExtension#0.0238+yUpperExtension;-0.0014-xLowerExtension#0.0038-yLowerExtension'
		sketch = self._create_sketch(pointString)
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex0",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0014-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","0.0038-yLowerExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex1",V(_createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox","0.0186+xUpperExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","0.0038-yLowerExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex2",V(_createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox","0.0186+xUpperExtension"),_createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox","0.0238+yUpperExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex3",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0014-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox","0.0238+yUpperExtension"),0)))
		part=empro.geometry.Model()
		...
		topAssembly.append(assembly)
		assembly=empro.geometry.Assembly()
		pointStrings=['0.0186#0.0132;0.0186#0.0144;-0.0014#0.0144;-0.0014#0.0132']
		...
		topAssembly.append(assembly)
		assembly=empro.geometry.Assembly()
		pointStrings=['0.0186#0.0038;0.0186#0.0238;-0.0014#0.0238;-0.0014#0.0038']
	...
	def create_ports( self, topAssembly, includeInvalidPorts=True, symbPinData=None):
		...
		head=V("(-0.0014) - (0)","(0.0138) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		tail=V("(-0.0014) - (0)","(0.0138) - (0)","(((mask_cond2_Zmax) + (mask_cond2_Zmin)) / (2)) - (0)")
		extent=empro.components.SheetExtent()
		extent.endPoint1Position=V("(-0.0014) - (0)","(0.0132) - (0)","(((mask_cond2_Zmax) + (mask_cond2_Zmin)) / (2)) - (0)")
		extent.endPoint2Position=V("(-0.0014) - (0)","(0.0144) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		...
		head=V("(0.0186) - (0)","(0.0138) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		tail=V("(0.0186) - (0)","(0.0138) - (0)","(((mask_cond2_Zmax) + (mask_cond2_Zmin)) / (2)) - (0)")
		extent=empro.components.SheetExtent()
		extent.endPoint1Position=V("(0.0186) - (0)","(0.0132) - (0)","(((mask_cond2_Zmax) + (mask_cond2_Zmin)) / (2)) - (0)")
		extent.endPoint2Position=V("(0.0186) - (0)","(0.0144) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
	...
	def create_parameters(self):
		...
		self._create_parameter("stack_tech_layer_3_Z", "0.018 mm", "Z of topology level (level 3 of stack tech)",True,fixGridAxis='Z')
		self._create_parameter("stack_tech_layer_5_Z", "0.818 mm", "Z of topology level (level 5 of stack tech)",True,fixGridAxis='Z')
		self._create_parameter("stack_tech_layer_7_Z", "0.836 mm", "Z of topology level (level 7 of stack tech)",True,fixGridAxis='Z')
		...
		self._create_parameter("mask_cond2_Zmax",str("0.018 mm"),"Zmax of mask cond2",True,fixGridAxis='Z')
		self._create_parameter("mask_cond_cond2_Zmin",str("0.018 mm"),"Zmin of mask cond_cond2",True,fixGridAxis='Z')
		self._create_parameter("mask_cond_cond2_Zmax",str("0.818 mm"),"Zmax of mask cond_cond2",True,fixGridAxis='Z')
		self._create_parameter("mask_cond_Zmin",str("0.818 mm"),"Zmin of mask cond",True,fixGridAxis='Z')
		self._create_parameter("mask_cond_Zmax",str("0.836 mm"),"Zmax of mask cond",True,fixGridAxis='Z')
